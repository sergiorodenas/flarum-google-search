...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  // create the route
  app.routes['flarum-ads'] = {
    path: '/flarum/ads',
    component: _components_AdsPage__WEBPACK_IMPORTED_MODULE_3__["default"].component()
  }; // bind the route we created to the three dots settings button

  app.extensionSettings['flarum-ads'] = function () {
    return m.route(app.route('flarum-ads'));
  };
  ...
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_components_AdminNav__WEBPACK_IMPORTED_MODULE_1___default.a.prototype, 'items', function (items) {
    items.add('flarum-ads', flarum_components_AdminLinkButton__WEBPACK_IMPORTED_MODULE_2___default.a.component({
      href: app.route('flarum-ads'),
      icon: 'fas fa-dollar-sign',
      children: 'Ads',
      description: app.translator.trans('flarum-ads.admin.tab.description')
    }));
  });
});
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return AdsPage; });
...
var AdsPage = /*#__PURE__*/function (_Component) {
  Object(_babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_0__["default"])(AdsPage, _Component);

  function AdsPage() {
    return _Component.apply(this, arguments) || this;
  }

  var _proto = AdsPage.prototype;
  ...
  _proto.init = function init() {
    ...
    this.settingsPrefix = 'sergiorodenas.flarum-ads';
  ...
  _proto.view = function view() {
    ...
    return [m('div', {
    ...
    }, [m('legend', {}, app.translator.trans('flarum-ads.admin.settings.start-from-post')), m('input', {
      value: this.values['start-from-post']() || 1,
      className: 'FormControl',
      oninput: m.withAttr('value', this.values['start-from-post'])
    })]), m('fieldset', {
      className: 'AdsPage-settings'
    }, [m('legend', {}, app.translator.trans('flarum-ads.admin.settings.between-n-posts')), m('input', {
      ...
      }, [m('legend', {}, app.translator.trans('flarum-ads.admin.positions.' + position + '.title')), m('textarea', {
        value: _this2.values[position]() || null,
        className: 'FormControl',
        placeholder: app.translator.trans('flarum-ads.admin.positions.' + position + '.placeholder'),
      ...
      children: app.translator.trans('flarum-ads.admin.buttons.save'),
...
flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.initializers.add('flarum-ads', function () {
  // add the admin pane
